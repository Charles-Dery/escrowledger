...
<main class="flex-1 flex flex-col md:ml-64 h-screen overflow-hidden bg-surface relative">
    <header class="flex justify-between items-center w-full px-6 py-3 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl font-manrope tracking-tight docked full-width top-0 z-50 shadow-sm dark:shadow-none tonal transition via surface-container-low">
        <div class="flex items-center flex-1">
            <button id="menu-btn" onclick="openMenu()" class="md:hidden mr-4 text-on-surface p-2 rounded-full hover:bg-surface-container-low transition-colors">
                ...
                <section class="space-y-6" data-aos="fade-up" data-aos-delay="140">
                    ...
                    <div class="space-y-4">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <form action="<?php echo URLROOT; ?>/buyer/inquire/<?php echo $property->id; ?>" method="POST">
                                            <button type="submit" class="px-3 py-1 rounded-full bg-primary text-white text-[10px] font-bold uppercase tracking-wider hover:opacity-90 transition-opacity">Buy</button>
                                        </form>
                        ...
                        <div class="bg-surface-container-lowest rounded-xl p-6 text-center">
                            ...
                            <a href="<?php echo URLROOT; ?>/buyer/catalog" class="inline-flex items-center justify-center px-4 py-2 rounded-full bg-primary text-white text-xs font-bold uppercase tracking-wider hover:opacity-90 transition-opacity">Browse Catalog</a>
                        </div>
                        <?php endif; ?>
                    </div>
                </section>
