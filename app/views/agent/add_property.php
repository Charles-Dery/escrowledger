...
<head>
    ...
    <title>Add New Property - Estate Ledger</title>
...
<a href="<?php echo URLROOT; ?>/agent/dashboard" class="text-on-surface-variant hover:text-on-surface transition-colors flex items-center justify-center p-2 rounded-full hover:bg-surface-container">
<span class="material-symbols-outlined">arrow_back</span>
</a>
<h2 class="font-headline font-bold tracking-tight text-2xl text-on-surface">Add New Property</h2>
</div>
<div class="flex items-center gap-4">
...
<form action="<?php echo URLROOT; ?>/agent/add_property" method="POST" enctype="multipart/form-data" class="space-y-12">
...
<input name="title" required class="w-full bg-surface-container-highest border-0 rounded-lg py-3 px-4 text-on-surface font-body text-sm focus:ring-0 placeholder-on-surface-variant/50 transition-all" id="title" placeholder="e.g., Modern Penthouse in Downtown" type="text"/>
</div>
...
<input name="price" required class="w-full bg-surface-container-highest border-0 rounded-lg py-3 pl-8 pr-4 text-on-surface font-body text-sm focus:ring-0 placeholder-on-surface-variant/50 transition-all" id="price" placeholder="0.00" type="number" step="0.01"/>
</div>
</div>
<div>
...
<input name="bedrooms" class="w-full bg-surface-container-highest border-0 rounded-lg py-3 px-4 text-on-surface font-body text-sm focus:ring-0 placeholder-on-surface-variant/50 transition-all" id="beds" placeholder="0" type="number"/>
</div>
<div>
<label class="block font-label text-sm font-medium text-on-surface mb-2" for="baths">Bathrooms</label>
<input name="bathrooms" class="w-full bg-surface-container-highest border-0 rounded-lg py-3 px-4 text-on-surface font-body text-sm focus:ring-0 placeholder-on-surface-variant/50 transition-all" id="baths" placeholder="0.0" step="0.5" type="number"/>
</div>
<div>
<label class="block font-label text-sm font-medium text-on-surface mb-2" for="sqft">Square Footage</label>
<div class="relative">
<input name="sqft" class="w-full bg-surface-container-highest border-0 rounded-lg py-3 px-4 pr-12 text-on-surface font-body text-sm focus:ring-0 placeholder-on-surface-variant/50 transition-all" id="sqft" placeholder="0" type="number"/>
...
<input name="year_built" class="w-full md:w-1/3 bg-surface-container-highest border-0 rounded-lg py-3 px-4 text-on-surface font-body text-sm focus:ring-0 placeholder-on-surface-variant/50 transition-all" id="year_built" placeholder="YYYY" type="number"/>
</div>
</div>
</div>
</section>
...
<input name="address" required class="w-full bg-surface-container-highest border-0 rounded-lg py-3 px-4 text-on-surface font-body text-sm focus:ring-0 placeholder-on-surface-variant/50 transition-all" id="address" placeholder="123 Main St" type="text"/>
</div>
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
<div class="md:col-span-1">
<label class="block font-label text-sm font-medium text-on-surface mb-2" for="city">City</label>
<input name="city" required class="w-full bg-surface-container-highest border-0 rounded-lg py-3 px-4 text-on-surface font-body text-sm focus:ring-0 placeholder-on-surface-variant/50 transition-all" id="city" placeholder="City" type="text"/>
</div>
<div class="md:col-span-1">
<label class="block font-label text-sm font-medium text-on-surface mb-2" for="state">State/Province</label>
<input name="state" required class="w-full bg-surface-container-highest border-0 rounded-lg py-3 px-4 text-on-surface font-body text-sm focus:ring-0 placeholder-on-surface-variant/50 transition-all" id="state" placeholder="State" type="text"/>
</div>
<div class="md:col-span-1">
<label class="block font-label text-sm font-medium text-on-surface mb-2" for="zip">Zip/Postal Code</label>
<input name="zip" required class="w-full bg-surface-container-highest border-0 rounded-lg py-3 px-4 text-on-surface font-body text-sm focus:ring-0 placeholder-on-surface-variant/50 transition-all" id="zip" placeholder="Zip" type="text"/>
</div>
</div>
</div>
</div>
...
<p class="font-body text-sm text-on-surface-variant">Upload images from your device or paste image URLs.</p>
</div>
<div class="md:w-2/3 bg-surface-container-lowest rounded-xl p-8 hover:bg-surface-container-high transition-colors duration-300">
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
<div>
<h4 class="font-label text-sm font-medium text-on-surface mb-3">Upload from Device</h4>
<div class="space-y-4">
<div>
<label class="block font-label text-xs font-medium text-on-surface-variant mb-2">Image 1 (Main) *</label>
...
<div>
<label class="block font-label text-xs font-medium text-on-surface-variant mb-2">Image 2</label>
...
<div>
<label class="block font-label text-xs font-medium text-on-surface-variant mb-2">Image 3</label>
...
<div>
<label class="block font-label text-xs font-medium text-on-surface-variant mb-2">Image 4</label>
...
<div>
<label class="block font-label text-xs font-medium text-on-surface-variant mb-2">Image 5</label>
...
<div>
<h4 class="font-label text-sm font-medium text-on-surface mb-3">Or Paste Image URLs</h4>
<div class="space-y-4">
<div>
<label class="block font-label text-xs font-medium text-on-surface-variant mb-2">Image URL 1 (Main)</label>
<input name="image_url_1" class="w-full bg-surface-container-highest border-0 rounded-lg py-2 px-4 text-sm" placeholder="https://example.com/image1.jpg" type="url"/>
</div>
<div>
<label class="block font-label text-xs font-medium text-on-surface-variant mb-2">Image URL 2</label>
<input name="image_url_2" class="w-full bg-surface-container-highest border-0 rounded-lg py-2 px-4 text-sm" placeholder="https://example.com/image2.jpg" type="url"/>
</div>
<div>
<label class="block font-label text-xs font-medium text-on-surface-variant mb-2">Image URL 3</label>
<input name="image_url_3" class="w-full bg-surface-container-highest border-0 rounded-lg py-2 px-4 text-sm" placeholder="https://example.com/image3.jpg" type="url"/>
</div>
<div>
<label class="block font-label text-xs font-medium text-on-surface-variant mb-2">Image URL 4</label>
<input name="image_url_4" class="w-full bg-surface-container-highest border-0 rounded-lg py-2 px-4 text-sm" placeholder="https://example.com/image4.jpg" type="url"/>
</div>
<div>
<label class="block font-label text-xs font-medium text-on-surface-variant mb-2">Image URL 5</label>
<input name="image_url_5" class="w-full bg-surface-container-highest border-0 rounded-lg py-2 px-4 text-sm" placeholder="https://example.com/image5.jpg" type="url"/>
</div>
</div>
</div>
</div>
...
<a href="<?php echo URLROOT; ?>/agent/dashboard" class="px-6 py-3 rounded-full text-on-surface font-body text-sm font-medium hover:bg-surface-container transition-colors">
                        Cancel
                    </a>
